...
class TestBackoff(unittest.TestCase):
    ...
    @patch('requests.get',side_effect=10*[mocked_get(status_code=500, json={"key1": "val1"})])
    ...
    @patch('requests.get',side_effect=10*[mocked_get(status_code=501, json={"key1": "val1"})])
    ...
    @patch('requests.get',side_effect=10*[mocked_get(status_code=502, json={"key1": "val1"})])
